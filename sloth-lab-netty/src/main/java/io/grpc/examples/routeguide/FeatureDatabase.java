 ...
 * </pre>
 */
public final class FeatureDatabase extends com.google.protobuf.GeneratedMessage implements
    ...
    private FeatureDatabase(com.google.protobuf.CodedInputStream input,
            ...
            while (!done) {
                ...
                switch (tag) {
                    ...
                    case 10: {
                        ...
                        feature_.add(input.readMessage(io.grpc.examples.routeguide.Feature.parser(),
                                        extensionRegistry));
                        break;
                    }
                }
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return io.grpc.examples.routeguide.RouteGuideProto.internal_static_routeguide_FeatureDatabase_fieldAccessorTable
                        .ensureFieldAccessorsInitialized(io.grpc.examples.routeguide.FeatureDatabase.class,
                                        io.grpc.examples.routeguide.FeatureDatabase.Builder.class);
    }
     ...
     * <code>repeated .routeguide.Feature feature = 1;</code>
     */
    public java.util.List<? extends io.grpc.examples.routeguide.FeatureOrBuilder> getFeatureOrBuilderList() {
        return feature_;
    }
     ...
     * <code>repeated .routeguide.Feature feature = 1;</code>
     */
    public io.grpc.examples.routeguide.FeatureOrBuilder getFeatureOrBuilder(int index) {
        return feature_.get(index);
    }
    ...
    public int getSerializedSize() {
        ...
        size = 0;
        for (int i = 0; i < feature_.size(); i++) {
            size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, feature_.get(i));
        }
        memoizedSize = size;
        return size;
    }
    ...
    public static io.grpc.examples.routeguide.FeatureDatabase parseFrom(com.google.protobuf.ByteString data)
    ...
    public static io.grpc.examples.routeguide.FeatureDatabase parseFrom(com.google.protobuf.CodedInputStream input)
                    throws java.io.IOException {
        return PARSER.parseFrom(input);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder> implements
        ...
        // Construct using
        // io.grpc.examples.routeguide.FeatureDatabase.newBuilder()
        private Builder() {
        ...
        public Builder mergeFrom(io.grpc.examples.routeguide.FeatureDatabase other) {
            if (other == io.grpc.examples.routeguide.FeatureDatabase.getDefaultInstance())
                return this;
            if (featureBuilder_ == null) {
                ...
                if (!other.feature_.isEmpty()) {
                    if (featureBuilder_.isEmpty()) {
                        ...
                        feature_ = other.feature_;
                        bitField0_ = (bitField0_ & ~0x00000001);
                        featureBuilder_ = com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders
                                        ? getFeatureFieldBuilder()
                                        : null;
                    } else {
        ...
        private java.util.List<io.grpc.examples.routeguide.Feature> feature_ = java.util.Collections.emptyList();
        ...
        private com.google.protobuf.RepeatedFieldBuilder<io.grpc.examples.routeguide.Feature, io.grpc.examples.routeguide.Feature.Builder, io.grpc.examples.routeguide.FeatureOrBuilder> featureBuilder_;
         ...
         * <code>repeated .routeguide.Feature feature = 1;</code>
         */
        public Builder setFeature(int index, io.grpc.examples.routeguide.Feature value) {
            if (featureBuilder_ == null) {
                if (value == null) {
         ...
         * <code>repeated .routeguide.Feature feature = 1;</code>
         */
        public Builder setFeature(int index, io.grpc.examples.routeguide.Feature.Builder builderForValue) {
            if (featureBuilder_ == null) {
                ensureFeatureIsMutable();
         ...
         * <code>repeated .routeguide.Feature feature = 1;</code>
         */
        public Builder addFeature(int index, io.grpc.examples.routeguide.Feature value) {
            if (featureBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
         ...
         * <code>repeated .routeguide.Feature feature = 1;</code>
         */
        public Builder addFeature(io.grpc.examples.routeguide.Feature.Builder builderForValue) {
            if (featureBuilder_ == null) {
                ensureFeatureIsMutable();
         ...
         * <code>repeated .routeguide.Feature feature = 1;</code>
         */
        public Builder addFeature(int index, io.grpc.examples.routeguide.Feature.Builder builderForValue) {
            if (featureBuilder_ == null) {
                ensureFeatureIsMutable();
         ...
         * <code>repeated .routeguide.Feature feature = 1;</code>
         */
        public Builder addAllFeature(java.lang.Iterable<? extends io.grpc.examples.routeguide.Feature> values) {
            if (featureBuilder_ == null) {
                ensureFeatureIsMutable();
                com.google.protobuf.AbstractMessageLite.Builder.addAll(values, feature_);
                onChanged();
            } else {
         ...
         * <code>repeated .routeguide.Feature feature = 1;</code>
         */
        public io.grpc.examples.routeguide.Feature.Builder getFeatureBuilder(int index) {
        ...
        public io.grpc.examples.routeguide.Feature.Builder addFeatureBuilder() {
            return getFeatureFieldBuilder().addBuilder(io.grpc.examples.routeguide.Feature.getDefaultInstance());
        }

        /**
         * <code>repeated .routeguide.Feature feature = 1;</code>
         */
        public io.grpc.examples.routeguide.Feature.Builder addFeatureBuilder(int index) {
            return getFeatureFieldBuilder().addBuilder(index, io.grpc.examples.routeguide.Feature.getDefaultInstance());
        }

        /**
         * <code>repeated .routeguide.Feature feature = 1;</code>
         */
        public java.util.List<io.grpc.examples.routeguide.Feature.Builder> getFeatureBuilderList() {
            return getFeatureFieldBuilder().getBuilderList();
        }

        private com.google.protobuf.RepeatedFieldBuilder<io.grpc.examples.routeguide.Feature, io.grpc.examples.routeguide.Feature.Builder, io.grpc.examples.routeguide.FeatureOrBuilder> getFeatureFieldBuilder() {
            if (featureBuilder_ == null) {
                featureBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<io.grpc.examples.routeguide.Feature, io.grpc.examples.routeguide.Feature.Builder, io.grpc.examples.routeguide.FeatureOrBuilder>(
                                feature_, ((bitField0_ & 0x00000001) == 0x00000001), getParentForChildren(), isClean());
                feature_ = null;
            }
    ...
    private static final com.google.protobuf.Parser<FeatureDatabase> PARSER = new com.google.protobuf.AbstractParser<FeatureDatabase>() {
        public FeatureDatabase parsePartialFrom(com.google.protobuf.CodedInputStream input,
                        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                        throws com.google.protobuf.InvalidProtocolBufferException {
            try {
